...
function saveCredentials(_a) {
    var title = _a.title, email = _a.email, password = _a.password;
    return __awaiter(this, void 0, void 0, function () {
        var xml;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    xml = xmlbuilder_1.default.create('database')
                        ...
                        .end({ pretty: true });
                    return [4 /*yield*/, promise_fs_1.writeFile(id + ".xml", xml)];
                case 1:
                    _b.sent();
                    return [2 /*return*/];
            }
