...
exports.torIPC = exports.torSetup = exports.Tor = void 0;
...
function torSetup({ ip = 'localhost', port = '9050', path = '', controlPort = '9051', controlPassword = 'giraffe' }) {
    ...
    return Object.assign(Object.assign({ torNewSession }, axios_1.default.create({
        'httpAgent': httpAgent(),
        'httpsAgent': httpsAgent(),
    })), { httpAgent,
        httpsAgent });
}
exports.torSetup = torSetup;
...
exports.torIPC = torIPC;
function torNewSession() {
    let commands = [
        'authenticate "' + torConfig.controlPassword + '"',
        'signal newnym',
