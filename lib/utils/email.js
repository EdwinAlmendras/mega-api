...
class TemporaryEmail extends Email {
    ...
    fetch() {
        return __awaiter(this, void 0, void 0, function* () {
            let { data } = yield axios_1.default.get(`${this.gateway}/${this.id}`);
            this.mails = data;
            return data;
        });
    }
    get(id) {
        return __awaiter(this, void 0, void 0, function* () {
            let { data } = yield axios_1.default.get(`${this.gateway}/${this.id}/${id}`);
            return data;
        });
    }
    new() {
        return __awaiter(this, void 0, void 0, function* () {
            let { data } = yield axios_1.default.get(`${this.gateway}/keepalive?mailbox=`);
