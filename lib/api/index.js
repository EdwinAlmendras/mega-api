...
class Api extends events_1.EventEmitter {
    ...
    request(json, retryno = 0, ignoreError = false) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            let params = {
                id: (this.counterId++).toString()
            };
            this.sid && (params.sid = this.sid);
            const url = `${this.gateway}cs?${querystring_1.stringify(params)}`;
            let { data, headers, status } = yield this.axios.post(url, [json]);
            let response = data[0];
            ...
            function retry() {
                return __awaiter(this, void 0, void 0, function* () {
                    let response = yield self.request(json, retryno + 1);
                    resolve(response);
                });
            }
        }));
