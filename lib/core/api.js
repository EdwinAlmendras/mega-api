...
class MegaApiClient extends events_1.EventEmitter {
    ...
    custom({ data, params, config, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield axios_1.default(Object.assign({ url: `${constants_1.API_GATEWAY_URL}cs`, params: qs, data }, config));
    ...
    */
    request(obj, { retryno = 0, transform = "" } = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { data, headers, status } = yield axios_1.default({
                url,
                data: [obj],
                params,
                method: "post",
            ...
            function retry() {
                return __awaiter(this, void 0, void 0, function* () {
                    const response = yield self.request(obj, { retryno: retryno + 1 });
