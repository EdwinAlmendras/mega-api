...
exports.API_GATEWAY_URL = exports.PATH_SESSION = exports.RSA_PRIVK_LENGTH = exports.ERRORS = void 0;
...
exports.ERRORS = {
    ...
    3: "EAGAIN (-3): A temporary congestion or server malfunction prevented your request from being processed. No data was altered. Retried times.",
...
exports.RSA_PRIVK_LENGTH = 43;
exports.PATH_SESSION = path_1.default.resolve("./session.json");
exports.API_GATEWAY_URL = "https://eu.api.mega.co.nz/";
