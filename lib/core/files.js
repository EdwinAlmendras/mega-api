...
const tiktok_scraper_1 = __importDefault(require("tiktok-scraper"));
const files_uploader_internal_1 = require("./files.uploader-internal");
...
class Uploader {
     ...
     */
    tiktok({ user, hashtag, music }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            let response;
            if (user) {
                response = yield tiktok_scraper_1.default.user(user, options);
            }
            else if (hashtag) {
                response = yield tiktok_scraper_1.default.hashtag(user, options);
            }
            else if (music) {
                response = yield tiktok_scraper_1.default.user(user, options);
            }
...
class Files extends events_1.default {
  ...
  t: "3WIFyQ7R" */
    ...
    uploader() {
        return new files_uploader_internal_1.UploaderInternal(this.client);
    }
    /**
